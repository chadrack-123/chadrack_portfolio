    ...
    <section className="min-h-screen flex items-center justify-center relative overflow-hidden px-4 pt-20 md:pt-0">
      ...
      <div className="max-w-7xl mx-auto text-center relative z-10">
        ...
        >
          ...
          >
            Transforming ideas into elegant code and turning data into actionable insights
          </motion.p>
          ...
          >
            ...
            <a
              href="#contact"
              className="px-8 py-3 bg-transparent border-2 border-blue-600 hover:bg-blue-600/10 rounded-lg font-semibold transition-all transform hover:scale-105"
            >
              Get in Touch
            </a>
          </motion.div>
