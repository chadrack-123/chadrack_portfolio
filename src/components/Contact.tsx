      ...
      <div className="max-w-4xl mx-auto">
        ...
        >
          ...
          <motion.button
            ...
            className={`w-full px-8 py-4 bg-gradient-to-r from-blue-600 to-purple-600 hover:from-blue-700 hover:to-purple-700 rounded-lg font-semibold text-white transition-all shadow-lg shadow-blue-500/20 ${
        ...
        >
          ...
          <div className="flex justify-center gap-6">
            <a
              href="https://github.com/chadrack-123"
              target="_blank"
            ...
            <a
              href="https://www.linkedin.com/in/chadrack-kavula-mulamba-67457318b/"
              target="_blank"
              rel="noopener noreferrer"
              className="text-gray-400 hover:text-blue-400 transition-colors"
            ...
            <a
              href="mailto:chadrackmulamba2@gmail.com"
              className="text-gray-400 hover:text-blue-400 transition-colors"
              aria-label="Email"
            >
