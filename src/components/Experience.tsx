...
const experiences = [
  {
    ...
    company: "",
    period: "",
    description: "Designed and delivered production-grade internal platforms that automated research publication workflows and reduced manual processing time by 20%.",
    skills: ["React", "Node.js", "Python", "SQL", "TypeScript", "AWS"],
    // Back side content - you can customize this
    detailedInfo: {
      responsibilities: [
  ...
  },
  {
    ...
    company: "",
    period: "",
    description: "Developed and evaluated machine learning models and reproducible data pipelines to support data-driven decision making.",
  ...
  },
  {
    ...
    company: "",
    period: "",
    description: "Built and deployed responsive web applications and RESTful APIs supporting authentication and business workflows.",
          ...
          {experiences.map((exp, index) => {
            ...
            return (
              <motion.div
                ...
                style={{ 
                  perspective: "1000px", 
                  minHeight: isFlipped ? "550px" : "200px",
              ...
              >
                ...
                >
                  {/* Front Side */}
                  <div
                    className="absolute w-full bg-gradient-to-br from-gray-800/50 to-gray-900/50 p-6 rounded-xl backdrop-blur-sm border border-gray-700 hover:border-blue-500/50 transition-all"
                    style={{
                  ...
                  {/* Back Side */}
                  <div
                    className="absolute top-0 left-0 w-full bg-gradient-to-br from-blue-800/50 to-purple-800/50 p-6 rounded-xl backdrop-blur-sm border border-blue-500/50"
                    style={{
                      backfaceVisibility: "hidden",
                      WebkitBackfaceVisibility: "hidden",
                      ...
                      <div className="space-y-3">
                        {exp.detailedInfo.achievements.map((achievement, i) => (
                          <motion.div
                            ...
                            initial={{ opacity: 0, x: -20 }}
                            animate={{ opacity: 1, x: 0 }}
                            transition={{ delay: 0.1 * (i + exp.detailedInfo.responsibilities.length), duration: 0.3 }}
                            className="flex gap-3 items-start group"
                          >
